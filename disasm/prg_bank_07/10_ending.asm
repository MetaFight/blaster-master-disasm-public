...
; ----------------------------------------------------------------------------
L_F31B: .byte   $0F,$30,$10,$00,$0F,$26,$16,$06 ; F31B
...
; ----------------------------------------------------------------------------
L_F359: .byte   $0F,$30,$10,$00,$0F,$27,$17,$07 ; F359
...
L_FA7A: jsr     L_FC42                          ; FA7A
        ...
        ldx     #$0F                            ; FA80
        txa                                     ; FA82
L_FA83: sta     Background_Palettes + BgPalette::Colour0,x ; FA83
        dex                                     ; FA85
        bpl     L_FA83                          ; FA86
        jsr     L_FC42                          ; FA88
        jsr     WaitNMI                         ; FA8B
...
; ----------------------------------------------------------------------------
L_FAF8: .addr   L_FAFA                          ; FAF8
; ----------------------------------------------------------------------------
L_FAFA: .byte   $D2,$20,$04,$00,$05,$00,$14,$00 ; FAFA
...
; ----------------------------------------------------------------------------
L_FCCD: .byte   $0F,$30,$36,$11,$0F,$30,$36,$27 ; FCCD
...
; ----------------------------------------------------------------------------
L_FCF9: .addr   L_FCFB                          ; FCF9
; ----------------------------------------------------------------------------
L_FCFB: .byte   $44,$49,$52,$45,$43,$54,$4F,$52 ; FCFB
