...
; ----------------------------------------------------------------------------
L_D94E: .byte   $00,$20,$00,$00                 ; D94E
L_D952: .byte   $00,$00,$1D,$00                 ; D952
L_D956: .byte   $00,$10,$EE,$00,$00,$10,$FF,$00 ; D956
; ----------------------------------------------------------------------------
L_D95E: lda     $08                             ; D95E
        sta     $0A                             ; D960
        lda     $09                             ; D962
...
L_DA3C: lda     ($33),y                         ; DA3C
        ...
        lda     ($27),y                         ; DA3F
        ldx     $0D                             ; DA41
        sta     ScreenTileMap + TileAttributes::Flags,x ; DA43
        jsr     L_DCDD                          ; DA46
        ldx     $19                             ; DA49
        ldy     #$00                            ; DA4B
        lda     ($31),y                         ; DA4D
...
L_DAF7: lda     ($33),y                         ; DAF7
        ...
        lda     ($27),y                         ; DAFA
        ldx     $0D                             ; DAFC
        sta     ScreenTileMap + TileAttributes::Flags,x ; DAFE
        jsr     L_DCDD                          ; DB01
L_DB04: ldx     $19                             ; DB04
        ldy     #$00                            ; DB06
        lda     ($31),y                         ; DB08
...
; ----------------------------------------------------------------------------
L_DC47: lda     ScreenTileMap + TileAttributes::Flags,x ; DC47
        lsr     a                               ; DC4A
        ror     L0000                           ; DC4B
        lsr     a                               ; DC4D
        ror     L0000                           ; DC4E
