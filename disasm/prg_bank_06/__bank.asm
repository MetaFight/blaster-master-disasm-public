...
Obj_TryCloneLoadedObjectIntoEmptySlot := $DF0F
LDF36           := $DF36
...
LE083           := $E083
LE0D8           := $E0D8
LoadedObj__Get_DeltaToPlayer_X        := $E0ED
LE0FA           := $E0FA
LE107           := $E107
LE120           := $E120
