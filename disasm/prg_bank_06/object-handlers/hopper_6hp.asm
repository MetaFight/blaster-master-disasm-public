...
.proc ObjHandler_Tank_5F_Gray_Hopper_6HP_Init
        jmp     _Done                           ; A7CB
...
.proc ObjHandler_Tank_60_Gray_Hopper_6HP_Attacking
        jmp     _OnScreenCheck                  ; A7EE
...
_Launch:
; Commit the heading to LoadedObj.Facing.
...
.proc ObjHandler_Tank_61_GrayHopper6HP_Patrolling
        jmp     _AfterPhysics                   ; A86E
