.macro MAC_object_handlers__crescent_roller
; ----------------------------------------------------------------------------
...
L_B6E7: lda     #$1A                            ; B6E7
        ...
        jsr     L_B81C                          ; B6EC
        lda     #$00                            ; B6EF
        sta     LoadedObj + Obj::Scratch0       ; B6F1
L_B6F3: rts                                     ; B6F3
...
L_B724: cmp     #$05                            ; B724
        bne     L_B72A                          ; B726
        inc     LoadedObj + Obj::Scratch0       ; B728
...
L_B74D: ldx     $09                             ; B74D
        ...
        lda     #$28                            ; B763
        sta     ObjectTable + Obj::Scratch1,x   ; B765
        lda     #$46                            ; B768
        sta     ObjectTable + Obj::Type,x       ; B76A
L_B76D: lda     Global_FrameCounter             ; B76D
        cmp     #$55                            ; B76F
        bne     L_B787                          ; B771
        dec     LoadedObj + Obj::Scratch0       ; B773
        lda     #$20                            ; B775
        sta     LoadedObj + Obj::Scratch2       ; B777
        jsr     L_B81C                          ; B779
        lda     #$00                            ; B77C
        sec                                     ; B77E
        sbc     LoadedObj + Obj::Velocity_X     ; B77F
        sta     LoadedObj + Obj::Velocity_X     ; B781
        lda     #$00                            ; B783
        sta     LoadedObj + Obj::Velocity_Y     ; B785
L_B787: lda     #$18                            ; B787
        sta     $40                             ; B789
        lda     #$10                            ; B78B
        sta     $41                             ; B78D
...
; ----------------------------------------------------------------------------
L_B826: lda     #$F8                            ; B826
L_B828: sta     LoadedObj + Obj::Velocity_X     ; B828
        rts                                     ; B82A

; ----------------------------------------------------------------------------
L_B82B: lda     LoadedObj + Obj::Scratch2       ; B82B
        beq     L_B831                          ; B82D
        dec     LoadedObj + Obj::Scratch2       ; B82F
L_B831: rts                                     ; B831
