...
L_A8D5: lda     #$06                            ; A8D5
        ...
        jsr     Obj_Get_DeltaToPlayer_X_q12_4   ; A8E6
        bpl     L_A8F2                          ; A8E9
        lda     #$00                            ; A8EB
        sec                                     ; A8ED
...
L_A91E: jsr     Obj_Get_DeltaToPlayer_X_q12_4                           ; A91E
        sta     $01                             ; A921
...
L_A93E: lda     #$11                            ; A93E
        jsr     Obj_ReadTile_WithOffset         ; A940
        bpl     L_A970                          ; A943
...
; ----------------------------------------------------------------------------
L_A9AE: lda     #$00                            ; A9AE
        jsr     Obj_SetOAMAttr_FlipX_and_Palette ; A9B0
