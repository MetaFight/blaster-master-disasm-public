...
.proc Bullet_WalkSurface
; Stash input arg Y into WR_Context_Dependent_05.
        sty     $05                             ; A670
...
; if X (TerrainCollisionFlags) != 0, skip to inside edge-wrap logic.
        bne     _TryInsideCornerWrap            ; A694
; otherwise,
_DoOutsideCornerWrap:
        sec                                     ; A696
        sbc     #$40                            ; A697
        jmp     _ApplyNewHeading                ; A699

; ----------------------------------------------------------------------------
_TryInsideCornerWrap:
        cpx     #$C0                            ; A69C
; If still colliding (bit6 or bit7 set: touching a surface), return $FF.
        bne     _Return_NotRotated              ; A69E
        clc                                     ; A6A0
