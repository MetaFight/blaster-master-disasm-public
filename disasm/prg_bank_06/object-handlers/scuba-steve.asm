...
; ----------------------------------------------------------------------------
L_B4A3: jmp     L_B508                          ; B4A3

; ----------------------------------------------------------------------------
L_B4A6: lda     #$80                            ; B4A6
        sta     LoadedObj_CollisionBox_HalfWidth; B4A8
        lda     #$40                            ; B4AA
        sta     LoadedObj_CollisionBox_HalfHeight; B4AC
        jsr     LE120                           ; B4AE
        ldx     #$02                            ; B4B1
        jsr     LE06A                           ; B4B3
