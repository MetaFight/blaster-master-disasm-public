...
.proc ObjHandler_Tank_2C_Pick_up_Pow_x1_Init
        nop                                     ; 9C1C
        nop                                     ; 9C1D
        nop                                     ; 9C1E
_Body:
...
; Delegate to shared init tail, passing in PickUp Type as A = 0
        beq     PickUp_Init_SharedTail          ; 9C21
.endproc
; -
; 
; 
; ObjType $2D: Pow x4 pickup - Init
.proc ObjHandler_Tank_2D_Pick_up_Pow_x4_Init
        nop                                     ; 9C23
        nop                                     ; 9C24
        nop                                     ; 9C25
_Body:
...
; Delegate to shared init tail, passing in PickUp Type as A = 1
        bne     PickUp_Init_SharedTail          ; 9C28
.endproc
; -
; 
; 
; ObjType $30: Gun x1 pickup - Init
.proc ObjHandler_Tank_30_Gun_gun_x1
        nop                                     ; 9C2A
        nop                                     ; 9C2B
        nop                                     ; 9C2C
_Body:
...
; Delegate to shared init tail, passing in PickUp Type as A = 2
        bne     PickUp_Init_SharedTail          ; 9C2F
.endproc
; -
; 
; 
; ObjType $31: Gun x4 pickup - Init
.proc ObjHandler_Tank_31_Pickup_Gun_x4_Init
        nop                                     ; 9C31
        nop                                     ; 9C32
        nop                                     ; 9C33
_Body:
...
; Delegate to shared init tail, passing in PickUp Type as A = 3
        bne     PickUp_Init_SharedTail          ; 9C36
.endproc
; -
; 
; 
; ObjType $2E: Hover x1 pickup - Init
.proc ObjHandler_Tank_2E_Pick_up_Hover_x1_Init
        nop                                     ; 9C38
        nop                                     ; 9C39
        nop                                     ; 9C3A
_Body:
...
; Delegate to shared init tail, passing in PickUp Type as A = 4
        bne     PickUp_Init_SharedTail          ; 9C3D
.endproc
; -
; 
; 
; ObjType $2F: Hover x4 pickup - Init
.proc ObjHandler_Tank_2F_Pick_up_Hover_x4_Init
        nop                                     ; 9C3F
        nop                                     ; 9C40
        nop                                     ; 9C41
_Body:
...
; Delegate to shared init tail, passing in PickUp Type as A = 5
        bne     PickUp_Init_SharedTail          ; 9C44
.endproc
; -
; 
; 
; ObjType $32: Homing Missile pickup - Init
.proc ObjHandler_Tank_32_Homing_Missiles_x20_Init
        nop                                     ; 9C46
        nop                                     ; 9C47
        nop                                     ; 9C48
_Body:
...
; Delegate to shared init tail, passing in PickUp Type as A = 6
        bne     PickUp_Init_SharedTail          ; 9C4B
.endproc
; -
; 
; 
; ObjType $33: Thunder Break x20 pickup - Init
.proc ObjHandler_Tank_33_Pick_up_Lightning_x20_Init
        nop                                     ; 9C4D
        nop                                     ; 9C4E
        nop                                     ; 9C4F
_Body:
...
; Delegate to shared init tail, passing in PickUp Type as A = 7
        bne     PickUp_Init_SharedTail          ; 9C52
.endproc
; -
; 
; 
; ObjType $33: Warheads x20 pickup - Init
.proc ObjHandler_Tank_34_Pickup_Warheads_x20_Init
        nop                                     ; 9C54
        nop                                     ; 9C55
        nop                                     ; 9C56
_Body:
...
; Delegate to shared init tail, passing in PickUp Type as A = 8
        bne     PickUp_Init_SharedTail          ; 9C59
.endproc
; -
; 
...
.proc ObjHandler_Tank_35_PickUp_Main
        jmp     _AfterAging                     ; 9C68
