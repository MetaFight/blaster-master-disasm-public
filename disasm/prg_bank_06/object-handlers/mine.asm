...
.proc ObjHandler_Tank_64_Mine_Init
        jmp     _Done                           ; A9CB
...
.proc ObjHandler_Tank_65_Mine_Main
        jmp     _ScreenTest                     ; A9DE
