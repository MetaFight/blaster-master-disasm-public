...
; ----------------------------------------------------------------------------
        ...
        jsr     L_A2E9                          ; B837
        lda     #$00                            ; B83A
        sta     LoadedObj_Velocity_Y            ; B83C
        sta     LoadedObj_Velocity_X            ; B83E
        sta     $50                             ; B840
L_B842: rts                                     ; B842
...
; ----------------------------------------------------------------------------
L_B8A2: lda     #$F0                            ; B8A2
L_B8A4: sta     LoadedObj_Velocity_X            ; B8A4
        jmp     L_B8EF                          ; B8A6
...
L_B8EF: lda     #$10                            ; B8EF
        ...
        lda     #$00                            ; B8FC
        sec                                     ; B8FE
        sbc     LoadedObj_Velocity_X            ; B8FF
        sta     LoadedObj_Velocity_X            ; B901
        jmp     LD7F8                           ; B903
