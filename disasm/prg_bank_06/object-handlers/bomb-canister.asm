.macro MAC_object_handlers__bomb_canister
; ----------------------------------------------------------------------------
L_B832: jmp     L_B842                          ; B832

; ----------------------------------------------------------------------------
L_B835: lda     #$1B                            ; B835
        jsr     TankEnemy_Init                  ; B837
        lda     #$00                            ; B83A
        sta     LoadedObj + Obj::Velocity_Y     ; B83C
        sta     LoadedObj + Obj::Velocity_X     ; B83E
        sta     LoadedObj + Obj::Scratch0       ; B840
L_B842: rts                                     ; B842

; ----------------------------------------------------------------------------
L_B843: jmp     L_B8EF                          ; B843
...
L_B846: lda     #$80                            ; B846
        ...
        lda     #$80                            ; B84A
        sta     $43                             ; B84C
        lda     LoadedObj + Obj::Scratch0       ; B84E
        bne     L_B87E                          ; B850
        lda     #$A7                            ; B852
...
; ----------------------------------------------------------------------------
L_B878: inc     LoadedObj + Obj::Scratch0       ; B878
        lda     #$00                            ; B87A
        sta     LoadedObj + Obj::Scratch2       ; B87C
L_B87E: cmp     #$01                            ; B87E
        bne     L_B8C8                          ; B880
        inc     LoadedObj + Obj::Scratch2       ; B882
        ldx     LoadedObj + Obj::Scratch2       ; B884
        lda     #$A8                            ; B886
        sta     LoadedObj + Obj::Scratch1       ; B888
        cpx     #$18                            ; B88A
        bcc     L_B8EF                          ; B88C
        lda     #$A9                            ; B88E
        sta     LoadedObj + Obj::Scratch1       ; B890
        cpx     #$30                            ; B892
        bne     L_B8A9                          ; B894
...
; ----------------------------------------------------------------------------
L_B8A2: lda     #$F0                            ; B8A2
L_B8A4: sta     LoadedObj + Obj::Velocity_X     ; B8A4
        jmp     L_B8EF                          ; B8A6

; ----------------------------------------------------------------------------
L_B8A9: jsr     Step_RNG                           ; B8A9
        ldx     #$04                            ; B8AC
        jsr     LE06A                           ; B8AE
        clc                                     ; B8B1
        adc     #$C0                            ; B8B2
...
; ----------------------------------------------------------------------------
L_B8DE: lda     #$A9                            ; B8DE
L_B8E0: sta     LoadedObj + Obj::Scratch1       ; B8E0
        lda     #$01                            ; B8E2
        jsr     Obj_GravityMoveBounce_Double    ; B8E4
        and     #$40                            ; B8E7
        beq     L_B8EF                          ; B8E9
        lda     #$00                            ; B8EB
        sta     LoadedObj + Obj::Velocity_Y     ; B8ED
L_B8EF: lda     #$10                            ; B8EF
        sta     $40                             ; B8F1
        lda     #$10                            ; B8F3
        sta     $41                             ; B8F5
        jsr     ScreenPos_Compute               ; B8F7
        beq     L_B906                          ; B8FA
        lda     #$00                            ; B8FC
        sec                                     ; B8FE
